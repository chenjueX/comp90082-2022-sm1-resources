...
• At the beginning of sprint 3, we did a retrospective summary for sprint 2. We discussed what strengths and weaknesses we had in the development process, and also what we are supposed to do to correct our weaknesses.
• At the end of this sprint, we also did a retrospective summary to check whether the previous problems have been solved. Besides, we did a group code review to let each team member know what functions have been developed. At the same time, we discussed bugs we encountered and resolved them together.
• We checked the completion status of all 43 user stories, indicating which were completed, which were cancelled, and which were not completed.
